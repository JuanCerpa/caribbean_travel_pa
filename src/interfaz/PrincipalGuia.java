...
public class PrincipalGuia extends javax.swing.JFrame {
    ...
    private void regConsulta(){
        ...
        for(int i =0;i<usuarios.length;i++){
            ...
            File url = new File(CrearConsulta+usuarios[i].getName());
            try {
                FileInputStream fis = new  FileInputStream(url);
                Properties mostrar = new Properties();
                mostrar.load(fis);
                
                String filas [] = {usuarios[i].getName().replace(".TuristasTXT",""),
...
//CREAR LA BASE DE DATOS DE LA SECCION DE CONSULTA
    private void CrearConsulta() {
        ...
        String archivo = txtCodigoConsulta.getText() + " .txt";
        File CrearConsul = new File(CrearConsulta);
        File CrearArchivo = new File(CrearConsulta + archivo);

        if (txtNombreConsulta.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Este Usuario no existe");
            ...
            try {
                if (CrearArchivo.exists()) {
                    ...
                    CrearConsul.mkdirs();
                    Formatter CrearForma = new Formatter(CrearConsulta + archivo);
                    CrearForma.format("%s\r\n%s\r\n%s\r\n%s\r\n%s\r\n", "NOMBRE: " + txtNombreConsulta.getText(), "TIPO: " + txtTipoConsulta.getText(),
                            "CODIGO: " + txtCodigoConsulta.getText(), "PRECIO: $" + txtPrecioConsulta.getText(),"CANTIDAD: " + txtCantidadConsulta.getText());
                    //%s\r\n PORCADA ESE CONJUNTO DE PALABRA SE CREA UN ESPACION DONDE GUARDAR
                    CrearForma.close();
                    JOptionPane.showMessageDialog(rootPane, "Registro exitoso");
                    ActualizarConsultas();
    ...
    private void EditarConsulta(){
        File url = new File(CrearConsulta+txtCodigoConsulta.getText()+ " .txt");//LO MISMO QUE PONEMOS EN LOS METODOS
        
        if(txtIdentificacion.getText().equals("")){
            JOptionPane.showMessageDialog(rootPane, "Digite el codigo de la consulta para poder buscar y editar");
        }
        else{
            if(url.exists()){
                try {
                    //ESTO PERMITIRA ESCRIBIR EN EL ARCHIVO ENCONTRADO
                    FileWriter permitir_editar = new FileWriter (CrearConsulta+txtCodigoConsulta.getText()+" .txt");
                    
                    String Codigo = "CODIGO:";//IDENTICO A LO QUE ESTA GUARDADO
                    String NombreConsulta = "NOMBRE:";
                    String TipoConsulta = "TIPO DE CONSULTA:";
                    String PrecioConsulta = "PRECIO: ";
                    String CantidadConsulta = "CANTIDAD: ";
                    
                    PrintWriter guardar = new PrintWriter(permitir_editar);
                    guardar.println(Codigo + txtCodigoConsulta.getText());
                    guardar.println(NombreConsulta + txtNombreConsulta.getText());
                    guardar.println(TipoConsulta + txtTipoConsulta.getText());
                    guardar.println(PrecioConsulta + txtPrecioConsulta.getText());
                    guardar.println(CantidadConsulta + txtCantidadConsulta.getText());
                    permitir_editar.close();
                    JOptionPane.showMessageDialog(rootPane, "Datos guardado correctamente!");
                    ActualizarConsultas();
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Error"+e);
                      ...
                      JOptionPane.showMessageDialog(rootPane, "La consulta no existe");
            }
        }
        }
    
     private void EliminarConsulta(){
        File qr = new File(CrearConsulta+txtCodigoConsulta.getText()+ " .txt");
        String botones [] = {"ELIMINAR ", "CANCELAR"};
        //CREAMOS ESTO PARA DAR LAS OPCIONES CUANDO DE AL BOTON ELIMINAR
        
        if(txtIdentificacion.getText().equals("")){
            JOptionPane.showMessageDialog(rootPane, "Digite el codigo de la consulta a Eliminar");
        }
        else{
            ...
            if(qr.exists()){
                ...
                try {
                    ...
                    int enserio = JOptionPane.showOptionDialog(rootPane, "Seguro que quiere eliminar la consulta con el codigo: "+txtCodigoConsulta.getText()
                            , "Eliminar", 0, 0, null, botones, null);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Gestion de Consultas");
        ...
        jLabel32.setText("Gestion de consultas");
        ...
        jPanel8.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 0, 130, 160));
        ...
        jPanel8.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 720, 230));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("REGISTRO DE TURISTAS");
        jPanel8.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, 200, 40));

        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/turistas.png"))); // NOI18N
        jPanel8.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 130, 160));
        ...
        jLabel13.setText("Registro de Turistas");
        jPanel10.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 210, 40));
        ...
        jPanel10.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 220, 440, 330));

        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/turistas.png"))); // NOI18N
        jPanel10.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 130, 160));
        ...
        jLabel14.setText("GESTION DE CONSULTAS");
        jPanel12.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 170, 280, 40));

        jPanel13.setBackground(new java.awt.Color(0, 204, 204));
        jPanel13.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel25.setForeground(new java.awt.Color(0, 0, 0));
        jLabel25.setText("TIPO DE CONSULTA:");
        jPanel13.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 30, -1, -1));
        ...
        jPanel13.add(txtTipoConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 50, 260, 30));

        jLabel26.setForeground(new java.awt.Color(0, 0, 0));
        jLabel26.setText("NOMBRE:");
        jPanel13.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, -1, -1));
        ...
        jPanel13.add(txtNombreConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 260, 30));

        jLabel27.setBackground(new java.awt.Color(0, 0, 0));
        jLabel27.setForeground(new java.awt.Color(0, 0, 0));
        jLabel27.setText("CODIGO:");
        jPanel13.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, -1, -1));
        ...
        jPanel13.add(txtCodigoConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 110, 30));

        jLabel28.setForeground(new java.awt.Color(0, 0, 0));
        jLabel28.setText("PRECIO:");
        jPanel13.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));

        txtPrecioConsulta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPrecioConsultaActionPerformed(evt);
            }
        });
        jPanel13.add(txtPrecioConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 140, 30));

        jLabel29.setForeground(new java.awt.Color(0, 0, 0));
        jLabel29.setText("CANTIDAD:");
        jPanel13.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, -1, -1));

        txtCantidadConsulta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCantidadConsultaActionPerformed(evt);
            }
        });
        jPanel13.add(txtCantidadConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, 120, 30));
        ...
        jPanel13.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 140, -1, -1));
        ...
        jPanel13.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 140, -1, -1));
        ...
        jPanel13.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 140, -1, -1));
        ...
        jPanel12.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 130, 160));
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jPanel12, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 860, Short.MAX_VALUE))
        );
    ...
    private void txtPrecioConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPrecioConsultaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtPrecioConsultaActionPerformed
    ...
    private void txtCantidadConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCantidadConsultaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCantidadConsultaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalGuia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalGuia().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtCantidadConsulta;
